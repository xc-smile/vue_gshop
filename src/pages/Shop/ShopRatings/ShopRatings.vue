<template>
  <div class="ratings">
    <div class="ratings-content">
      ...
      <rating-selector :selectorRateType="selectorRateType"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      filterRatings () {
        // 取出相关数据
        const {ratings, selectorRateType, onlyContent} = this
        // 返回过滤后的数组
        return ratings.filter(rating => {
           ...
           */
          return (selectorRateType===2 || selectorRateType===rateType) && (!onlyContent || text.length>0)
        })
      }
    },
    mounted() {
